...
class CGraphicTextInstance
{
	...
	protected:
		...
		{
			short x = 0;
			CGraphicImageInstance* pInstance = nullptr;
		};
		bool EmojiPathProcess(const std::wstring& emojiBuffer, SEmoji& kEmoji, int& x, CGraphicFontTexture::TCharacterInfomation*& pSpaceInfo, CGraphicFontTexture*& pFontTexture, const UINT & dataCodePage, const DWORD & dwColor);
#endif
