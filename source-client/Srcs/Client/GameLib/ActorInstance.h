...
class CActorInstance : public IActorInstance, public IFlyTargetableObject
{
	...
	public:
		...
		void AttachAcce(DWORD dwParentPartIndex, DWORD dwPartIndex, CItemData* pItemData);
		void AttachAcce(DWORD dwItemIndex, DWORD dwParentPartIndex, DWORD dwPartIndex);
#endif
	...
	public:
		...
		bool PushOnceMotion(DWORD dwMotion, float fBlendTime = 0.1f, float fSpeedRatio=1.0f);
		bool PushLoopMotion(DWORD dwMotion, float fBlendTime = 0.1f, float fSpeedRatio=1.0f);
	...
	protected:
		...
		bool		__BindMotionData(DWORD dwMotionKey);
	...
	public:
		void	SetQuiverEffectID(DWORD dwEffectID) { m_dwQuiverEffectID = dwEffectID; }
		DWORD	GetQuiverEffectID() const { return m_dwQuiverEffectID; }
	protected:
		DWORD	m_dwQuiverEffectID{};
#endif
};
