...
{ "ER_TABLESPACE_MISSING", 1812, "Tablespace \'%-.192s\' is missing" },
...
{ "ER_FILE_CORRUPT", 1885, "File %s is corrupted" },
{ "ER_ERROR_ON_MASTER", 1886, "Query partially completed on the master (error on master: %d) and was aborted. There is a chance that your master is inconsistent at this point. If you are sure that your master is ok, run this query manually on the slave and then restart the slave with SET GLOBAL SQL_SLAVE_SKIP_COUNTER=1; START SLAVE;. Query:\'%s\'" },
{ "ER_INCONSISTENT_ERROR", 1887, "Query caused different errors on master and slave. Error on master: message (format)=\'%s\' error code=%d; Error on slave:actual message=\'%s\', error code=%d. Default database:\'%s\'. Query:\'%s\'" },
{ "ER_STORAGE_ENGINE_NOT_LOADED", 1888, "Storage engine for table \'%s\'.\'%s\' is not loaded." },
{ "ER_GET_STACKED_DA_WITHOUT_ACTIVE_HANDLER", 1889, "GET STACKED DIAGNOSTICS when handler not active" },
{ "ER_WARN_LEGACY_SYNTAX_CONVERTED", 1890, "%s is no longer supported. The statement was converted to %s." },
{ "ER_BINLOG_UNSAFE_FULLTEXT_PLUGIN", 1891, "Statement is unsafe because it uses a fulltext parser plugin which may not return the same value on the slave." },
{ "ER_CANNOT_DISCARD_TEMPORARY_TABLE", 1892, "Cannot DISCARD/IMPORT tablespace associated with temporary table" },
{ "ER_FK_DEPTH_EXCEEDED", 1893, "Foreign key cascade delete/update exceeds max depth of %d." },
{ "ER_COL_COUNT_DOESNT_MATCH_PLEASE_UPDATE_V2", 1894, "Column count of %s.%s is wrong. Expected %d, found %d. Created with MySQL %d, now running %d. Please use mysql_upgrade to fix this error." },
{ "ER_WARN_TRIGGER_DOESNT_HAVE_CREATED", 1895, "Trigger %s.%s.%s does not have CREATED attribute." },
{ "ER_REFERENCED_TRG_DOES_NOT_EXIST", 1896, "Referenced trigger \'%s\' for the given action time and event type does not exist." },
{ "ER_EXPLAIN_NOT_SUPPORTED", 1897, "EXPLAIN FOR CONNECTION command is supported only for SELECT/UPDATE/INSERT/DELETE/REPLACE" },
{ "ER_INVALID_FIELD_SIZE", 1898, "Invalid size for column \'%-.192s\'." },
{ "ER_MISSING_HA_CREATE_OPTION", 1899, "Table storage engine \'%-.64s\' found required create option missing" },
{ "ER_ENGINE_OUT_OF_MEMORY", 1900, "Out of memory in storage engine \'%-.64s\'." },
{ "ER_PASSWORD_EXPIRE_ANONYMOUS_USER", 1901, "The password for anonymous user cannot be expired." },
{ "ER_SLAVE_SQL_THREAD_MUST_STOP", 1902, "This operation cannot be performed with a running slave sql thread; run STOP SLAVE SQL_THREAD first" },
{ "ER_NO_FT_MATERIALIZED_SUBQUERY", 1903, "Cannot create FULLTEXT index on materialized subquery" },
{ "ER_INNODB_UNDO_LOG_FULL", 1904, "Undo Log error: %s" },
{ "ER_INVALID_ARGUMENT_FOR_LOGARITHM", 1905, "Invalid argument for logarithm" },
{ "ER_SLAVE_CHANNEL_IO_THREAD_MUST_STOP", 1906, "This operation cannot be performed with a running slave io thread; run STOP SLAVE IO_THREAD FOR CHANNEL \'%s\' first." },
{ "ER_WARN_OPEN_TEMP_TABLES_MUST_BE_ZERO", 1907, "This operation may not be safe when the slave has temporary tables. The tables will be kept open until the server restarts or until the tables are deleted by any replicated DROP statement. Suggest to wait until slave_open_temp_tables = 0." },
{ "ER_WARN_ONLY_MASTER_LOG_FILE_NO_POS", 1908, "CHANGE MASTER TO with a MASTER_LOG_FILE clause but no MASTER_LOG_POS clause may not be safe. The old position value may not be valid for the new binary log file." },
{ "ER_QUERY_TIMEOUT", 1909, "Query execution was interrupted, max_statement_time exceeded" },
{ "ER_NON_RO_SELECT_DISABLE_TIMER", 1910, "Select is not a read only statement, disabling timer" },
{ "ER_DUP_LIST_ENTRY", 1911, "Duplicate entry \'%-.192s\'." },
{ "ER_SQL_MODE_NO_EFFECT", 1912, "\'%s\' mode no longer has any effect. Use STRICT_ALL_TABLES or STRICT_TRANS_TABLES instead." },
{ "ER_AGGREGATE_ORDER_FOR_UNION", 1913, "Expression #%u of ORDER BY contains aggregate function and applies to a UNION" },
{ "ER_AGGREGATE_ORDER_NON_AGG_QUERY", 1914, "Expression #%u of ORDER BY contains aggregate function and applies to the result of a non-aggregated query" },
{ "ER_SLAVE_WORKER_STOPPED_PREVIOUS_THD_ERROR", 1915, "Slave worker has stopped after at least one previous worker encountered an error when slave-preserve-commit-order was enabled. To preserve commit order, the last transaction executed by this thread has not been committed. When restarting the slave after fixing any failed threads, you should fix this worker as well." },
{ "ER_DONT_SUPPORT_SLAVE_PRESERVE_COMMIT_ORDER", 1916, "slave_preserve_commit_order is not supported %s." },
{ "ER_SERVER_OFFLINE_MODE", 1917, "The server is currently in offline mode" },
{ "ER_GIS_DIFFERENT_SRIDS", 1918, "Binary geometry function %s given two geometries of different srids: %u and %u, which should have been identical." },
{ "ER_GIS_UNSUPPORTED_ARGUMENT", 1919, "Calling geometry function %s with unsupported types of arguments." },
{ "ER_GIS_UNKNOWN_ERROR", 1920, "Unknown GIS error occured in function %s." },
{ "ER_GIS_UNKNOWN_EXCEPTION", 1921, "Unknown exception caught in GIS function %s." },
{ "ER_GIS_INVALID_DATA", 1922, "Invalid GIS data provided to function %s." },
{ "ER_BOOST_GEOMETRY_EMPTY_INPUT_EXCEPTION", 1923, "The geometry has no data in function %s." },
{ "ER_BOOST_GEOMETRY_CENTROID_EXCEPTION", 1924, "Unable to calculate centroid because geometry is empty in function %s." },
{ "ER_BOOST_GEOMETRY_OVERLAY_INVALID_INPUT_EXCEPTION", 1925, "Geometry overlay calculation error: geometry data is invalid in function %s." },
{ "ER_BOOST_GEOMETRY_TURN_INFO_EXCEPTION", 1926, "Geometry turn info calculation error: geometry data is invalid in function %s." },
{ "ER_BOOST_GEOMETRY_SELF_INTERSECTION_POINT_EXCEPTION", 1927, "Analysis procedures of intersection points interrupted unexpectedly in function %s." },
{ "ER_BOOST_GEOMETRY_UNKNOWN_EXCEPTION", 1928, "Unknown exception thrown in function %s." },
{ "ER_STD_BAD_ALLOC_ERROR", 1929, "Memory allocation error: %-.256s in function %s." },
{ "ER_STD_DOMAIN_ERROR", 1930, "Domain error: %-.256s in function %s." },
{ "ER_STD_LENGTH_ERROR", 1931, "Length error: %-.256s in function %s." },
{ "ER_STD_INVALID_ARGUMENT", 1932, "Invalid argument error: %-.256s in function %s." },
{ "ER_STD_OUT_OF_RANGE_ERROR", 1933, "Out of range error: %-.256s in function %s." },
{ "ER_STD_OVERFLOW_ERROR", 1934, "Overflow error error: %-.256s in function %s." },
{ "ER_STD_RANGE_ERROR", 1935, "Range error: %-.256s in function %s." },
{ "ER_STD_UNDERFLOW_ERROR", 1936, "Underflow error: %-.256s in function %s." },
{ "ER_STD_LOGIC_ERROR", 1937, "Logic error: %-.256s in function %s." },
{ "ER_STD_RUNTIME_ERROR", 1938, "Runtime error: %-.256s in function %s." },
{ "ER_STD_UNKNOWN_EXCEPTION", 1939, "Unknown exception: %-.384s in function %s." },
{ "ER_GIS_DATA_WRONG_ENDIANESS", 1940, "Geometry byte string must be little endian." },
{ "ER_CHANGE_MASTER_PASSWORD_LENGTH", 1941, "The password provided for the replication user exceeds the maximum length of 32 characters" },
{ "ER_USER_LOCK_WRONG_NAME", 1942, "Incorrect user-level lock name \'%-.192s\'." },
{ "ER_USER_LOCK_DEADLOCK", 1943, "Deadlock found when trying to get user-level lock; try rolling back transaction/releasing locks and restarting lock acquisition." },
{ "ER_REPLACE_INACCESSIBLE_ROWS", 1944, "REPLACE cannot be executed as it requires deleting rows that are not in the view" },
{ "ER_ALTER_OPERATION_NOT_SUPPORTED_REASON_GIS", 1945, "Do not support online operation on table with GIS index" },
{ "ER_ILLEGAL_USER_VAR", 1946, "User variable name \'%-.100s\' is illegal" },
{ "ER_GTID_MODE_OFF", 1947, "Cannot %s when GTID_MODE = OFF." },
{ "ER_UNSUPPORTED_BY_REPLICATION_THREAD", 1948, "Cannot %s from a replication slave thread." },
{ "ER_INCORRECT_TYPE", 1949, "Incorrect type for argument %s in function %s." },
{ "ER_FIELD_IN_ORDER_NOT_SELECT", 1950, "Expression #%u of ORDER BY clause is not in SELECT list, references column \'%-.192s\' which is not in SELECT list; this is incompatible with %s" },
{ "ER_AGGREGATE_IN_ORDER_NOT_SELECT", 1951, "Expression #%u of ORDER BY clause is not in SELECT list, contains aggregate function; this is incompatible with %s" },
{ "ER_INVALID_RPL_WILD_TABLE_FILTER_PATTERN", 1952, "Supplied filter list contains a value which is not in the required format \'db_pattern.table_pattern\'" },
{ "ER_NET_OK_PACKET_TOO_LARGE", 1953, "OK packet too large" },
{ "ER_INVALID_JSON_DATA", 1954, "Invalid JSON data provided to function %s: %s" },
{ "ER_INVALID_GEOJSON_MISSING_MEMBER", 1955, "Invalid GeoJSON data provided to function %s: Missing required member \'%s\'" },
{ "ER_INVALID_GEOJSON_WRONG_TYPE", 1956, "Invalid GeoJSON data provided to function %s: Member \'%s\' must be of type \'%s\'" },
{ "ER_INVALID_GEOJSON_UNSPECIFIED", 1957, "Invalid GeoJSON data provided to function %s" },
{ "ER_DIMENSION_UNSUPPORTED", 1958, "Unsupported number of coordinate dimensions in function %s: Found %u, expected %u" },
{ "ER_SLAVE_CHANNEL_DOES_NOT_EXIST", 1959, "Slave channel \'%s\' does not exist." },
{ "ER_SLAVE_MULTIPLE_CHANNELS_HOST_PORT", 1960, "A slave channel \'%s\' already exists for the given host and port combination." },
{ "ER_SLAVE_CHANNEL_NAME_INVALID_OR_TOO_LONG", 1961, "Couldn\'t create channel: Channel name is either invalid or too long." },
{ "ER_SLAVE_NEW_CHANNEL_WRONG_REPOSITORY", 1962, "To have multiple channels, repository cannot be of type FILE; Please check the repository configuration and convert them to TABLE." },
{ "ER_SLAVE_CHANNEL_DELETE", 1963, "Cannot delete slave info objects for channel \'%s\'." },
{ "ER_SLAVE_MULTIPLE_CHANNELS_CMD", 1964, "Multiple channels exist on the slave. Please provide channel name as an argument." },
{ "ER_SLAVE_MAX_CHANNELS_EXCEEDED", 1965, "Maximum number of replication channels allowed exceeded." },
{ "ER_SLAVE_CHANNEL_MUST_STOP", 1966, "This operation cannot be performed with a running replication threads; run STOP SLAVE FOR CHANNEL \'%s\' first" },
{ "ER_SLAVE_CHANNEL_NOT_RUNNING", 1967, "This operation requires a running replication threads; configure slave and run START SLAVE FOR CHANNEL \'%s\'" },
{ "ER_SLAVE_CHANNEL_WAS_RUNNING", 1968, "Replication thread(s) for channel \'%s\' are already runnning." },
{ "ER_SLAVE_CHANNEL_WAS_NOT_RUNNING", 1969, "Replication thread(s) for channel \'%s\' are already stopped." },
{ "ER_SLAVE_CHANNEL_SQL_THREAD_MUST_STOP", 1970, "This operation cannot be performed with a running slave sql thread; run STOP SLAVE SQL_THREAD FOR CHANNEL \'%s\' first." },
{ "ER_SLAVE_CHANNEL_SQL_SKIP_COUNTER", 1971, "When sql_slave_skip_counter > 0, it is not allowed to start SQL threads for multiple channels. To use sql_slave_skip_counter, stop SQL threads of all channels and execute START SLAVE FOR CHANNEL statement." },
{ "ER_WRONG_FIELD_WITH_GROUP_V2", 1972, "Expression #%u of %s is not in GROUP BY clause and contains nonaggregated column \'%-.192s\' which is not functionally dependent on columns in GROUP BY clause; this is incompatible with sql_mode=only_full_group_by" },
{ "ER_MIX_OF_GROUP_FUNC_AND_FIELDS_V2", 1973, "In aggregated query without GROUP BY, expression #%u of %s contains nonaggregated column \'%-.192s\'; this is incompatible with sql_mode=only_full_group_by" },
