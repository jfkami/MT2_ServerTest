...
window = {
	...
	(
		...
		{
			"name" : "desc_phase", "type" : "image", "x" : 0, "y" : BOARD_Y - NAME_Y - 35, "image" : ROOT_PATH + "public_intro_btn/descPhase_btn.sub",
			"children" :
			(
				{
			...
			(
				{ 
					...
					(
						...
						{ "name" : "raceName_Text",	"type" : "text", "x" : 100, "y" : 1, "r" : 0.7843, "g" : 0.7843, "b" : 0.7843, "text" : localeInfo.JOB_WARRIOR, "text_horizontal_align" : "center"}
		...
		##Character ID, MAKE OR CANCEL ##
		{
			...
			"x" : SCREEN_WIDTH/2 - 111, "y" : SCREEN_HEIGHT - SCREEN_HEIGHT*(70)/600.0 - 31,
			...
			(
				{
					...
					"x" : 30, "y" : 2, "r" : 0.7843, "g" : 0.7843, "b" : 0.7843,
